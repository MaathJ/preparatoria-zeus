            ...
            <div class="modal-content">
                ...
                <div class="modal-body container-fluid">
                    <form action="./Alumno/R_alumno.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="mb-3 d-flex text-wrap ml-2">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 mx-4 d-grid justify-content-center align-items-center">
                                ...
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label for="Direccion-name" class="form-label" style="color: black;">Ciudad:</label>
                                    <input type="text" name="txtciudad" class="form-control mx-5" id="Ciudad-name" required>
                                </div>
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label for="Direccion-name" class="form-label" style="color: black;">Direccion:</label>
                                    <input type="text" name="txtdireccion" class="form-control mx-5" id="Direccion-name">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    ...
                                    <!-- ... (PHP logic for options) ... -->
                                    <select class="form-control mx-4" name="lstarea" id="area-alumno">
                                    </select>
                                </div>
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2" for="carrera">Carrera:</label>
                                    <select class="form-control mx-4" name="lstcarrera" id="carrera-alumno">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2" for="universidad">Universidad:</label>
                                    <select class="form-control mx-4" name="lstuniversidad" id="universidad-alumno">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2 text-nowrap" for="nombrea-alumno">Apellidos y Nombres:</label>
                                    <input name="nombrea-alumno" class="form-control mx-4 my-0 p-0" type="text" id="Nombrea-alumno">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2 text-nowrap" for="celulara-alumno">Celular:</label>
                                    <input name="celulara-alumno" class="form-control mx-4 my-0 p-0" type="text" id="Celulara-alumno">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <form action="./Alumno/U_alumno.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label for="Direccion-name" class="form-label" style="color: black;">Ciudad:</label>
                                    <input type="text" name="txtciudadU" class="form-control mx-5" id="Ciudad-nameU" required>
                                </div>
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label for="Direccion-name" class="form-label" style="color: black;">Direccion:</label>
                                    <input type="text" name="txtdireccionU" class="form-control mx-5" id="Direccion-nameU">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2" for="area">Area:</label>
                                    <!-- ... (PHP logic for options) ... -->
                                    <select class="form-control mx-4" name="lstareaU" id="Area-alumnoU">
                                    </select>
                                </div>
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2" for="carrera">Carrera:</label>
                                    <select class="form-control mx-4" name="lstcarreraU" id="Carrera-alumnoU">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2" for="universidad">Universidad:</label>
                                    <select class="form-control mx-4" name="lstuniversidadU" id="Universidad-alumnoU">
                                        <option value="UNAP" selected>UNAP</option>
                                        <option value="UNSA">UNSA</option>
                                        <option value="UNAJ">UNAJ</option>
                                        <option value="Otros">Otros</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2 text-nowrap" for="nombrea-alumno">Apellidos y Nombres:</label>
                                    <input name="nombrea-alumnoU" class="form-control mx-4 my-0 p-0" type="text" id="Nombrea-alumnoU">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <label class="ml-2 text-nowrap" for="celulara-alumno">Celular:</label>
                                    <input name="celulara-alumnoU" class="form-control mx-4 my-0 p-0" type="text" id="Celulara-alumnoU">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <form action="./Alumno/U_alumno.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <input type="text" name="txtapellidoU" class="form-control" id="Apellido-nameU" required>
                                    <input type="text" name="id_alumnoU" class="form-control" id="id_alumnoU" hidden required>
                                </div>
                                <div class="mb-3 d-flex text-wrap ml-2">
                                    <input type="text" name="txtnombreU" class="sm-5 form-control" id="Nombre-nameU" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 mx-4 d-grid justify-content-center align-items-center">
                                    <img src="./src/assets/images/img_fond.jpg" alt="avatar" id="img2" width="200" height="200" required>
